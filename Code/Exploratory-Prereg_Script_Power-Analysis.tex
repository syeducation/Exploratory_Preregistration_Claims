...
calculate it as ɸ =.18. This corresponded to an approximate difference
in prevalence of 20\%.
...
Thus, we used ɸ =.18 as our estimate for the present study. The
pwr.chisq.test function from the pwr package in R (Champely et al.,
2020) indicated a necessary total sample size of 297.37 for a 2x2
...
an effect size of Cramer's V = .21 and a suggested sample size of
218.47. Relaxing these assumptions in different ways leads to a range of
effect sizes from Cramer's V =.19-21. Taken together, the power analysis
indicates a total sample of 300 articles will be sufficient for the aims
of the study.
